...
extension Scanner {
  ...
  func scanCharacters(from set: CharacterSet) -> String? {
    var value: NSString? = ""
    if scanCharacters(from: set as CharacterSet, into: &value), let value = value as String? {
      return value
    }
    return nil
  }
  ...
  func scanUpToCharacters(from set: CharacterSet) -> String? {
    var value: NSString? = ""
    if scanUpToCharacters(from: set, into: &value), let value = value as String? {
      return value
    }
    return nil
  }
  ...
  func scanString(str: String) -> String? {
    var value: NSString? = ""
    if scanString(str, into: &value), let value = value as String? {
      return value
    }
    return nil
  }
  ...
  func scanUpTo(str: String) -> String? {
    var value: NSString? = ""
    if scanUpTo(str, into: &value), let value = value as String? {
      return value
    }
    return nil
  }
